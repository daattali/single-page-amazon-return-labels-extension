var sparlOptions = {
  init : function() {
    ...
    document.getElementById('remove_print').addEventListener('click', function(e) {
      chrome.storage.sync.set({ sparl_remove_print : document.getElementById('remove_print').checked });
    });
    document.getElementById('remove_web').addEventListener('click', function(e) {
      chrome.storage.sync.set({ sparl_remove_web : document.getElementById('remove_web').checked });
    });
    document.getElementById('remove_items').addEventListener('click', function(e) {
      chrome.storage.sync.set({ sparl_remove_items : document.getElementById('remove_items').checked });
    });
    document.getElementById('print_scale').addEventListener('change', function(e) {
      ...
      chrome.storage.sync.set({ sparl_print_scale : scale });
    });
  },
